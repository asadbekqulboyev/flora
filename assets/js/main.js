document.addEventListener("DOMContentLoaded", () => {
  ...
  let modal_btn2 = document.querySelectorAll(".modal_open2");

    modal_btn2.forEach((el) => {
      el.addEventListener("click", (e) => {
        e.preventDefault();
        document.querySelector(".modal2").classList.add("active");
      });
    });
    const modal_close2 = document.querySelectorAll(".modal_exit");

    modal_close2.forEach((btn) => {
      btn.addEventListener("click", () => {
